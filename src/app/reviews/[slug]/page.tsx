      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-20 py-8">
           ...
           <div id="expert-review" className="bg-white rounded-lg shadow-sm p-6">
              ...
              {website.waystoEarn && (
                <div className="flex flex-wrap gap-2 mt-4 mb-4">
                  {website.waystoEarn.split(',').map((way, index) => (
                    <span
                      key={index}
                      className="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-blue-100 text-blue-800 hover:bg-blue-200 transition-colors cursor-default"
                    >
        ...
        <div className="lg:hidden space-y-8">
         ...
         <div id="expert-review" className="bg-white rounded-lg shadow-sm p-6">
          ...
          {/* Mobile Sidebar - After Expert Review */}
          <div className="space-y-6">
            {/* Legitimacy Check */}
            <div className="bg-white rounded-lg shadow-sm p-6 text-center">
              <h3 className="text-lg font-bold text-gray-900 mb-2">
