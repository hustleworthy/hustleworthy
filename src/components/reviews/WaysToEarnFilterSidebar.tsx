...
interface WaysToEarnFilterSidebarProps {
...
export default function WaysToEarnFilterSidebar({
  filters,
  basePath,
  hasActiveFilters,
  isOpen,
  onToggle,
}: WaysToEarnFilterSidebarProps) {
          ...
          <div ref={payoutDropdownRef}>
            ...
            <div className="relative">
              ...
              >
                ...
                <svg
                  className={`w-4 h-4 transition-transform ${isPayoutDropdownOpen ? 'rotate-180' : ''}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
