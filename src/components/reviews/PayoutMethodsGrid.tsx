...
interface PayoutMethodsGridProps {
  websites: Website[]
  currentPage: number
  pageSize: number
...
export default function PayoutMethodsGrid({
  websites,
  currentPage,
  pageSize,
  totalWebsitesCount,
  ...
  return (
    <>
                ...
                <div className="w-full lg:w-4/5 space-y-3 sm:space-y-4">
                  ...
                  <div className="flex justify-center sm:justify-end pt-2">
                    <Link
                      ...
                      className="bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 sm:px-6 rounded-lg transition-colors duration-200 text-sm w-full sm:w-auto text-center"
                    >
                      Go to Full Review
                    </Link>
                  </div>
      ...
      {totalWebsitesCount > pageSize && (
        <nav aria-label="Payout methods pagination" className="mt-8 sm:mt-12 px-4">
