...
const seedData = [
  {
    ...
    expertRating: 4.9,
    expertTips: [
      'Complete the initial profiling survey immediately to unlock higher-value surveys.',
      'Focus on surveys with longer durations (best pay ratio) and avoid low-pay "game" tasks once past the initial easy tiers.',
      'Use referral code to earn 15% commission on referrals\' earnings (provided by PollPay, not deducted from their balance).',
      'If possible, switch PayPal currency to EUR (threshold €15) if you live in Europe to redeem faster.',
      'Check the "Offers" tab daily for new app-trial or promo tasks that often pay $0.50-$2 each'
    ],
    isitLegit: true,
  ...
  },
  {
    ...
    expertRating: 4.7,
    expertTips: [
      'Complete your profile thoroughly for better survey matching',
      'Check for new surveys multiple times per day',
      'Focus on demographic-specific surveys for higher payouts'
    ],
    isitLegit: true,
